...
%>
	...
	<%-- LIST ORDER DETAILS BY ORDERID --%>
		...
		<button class="btn btn-proceed" style="padding:10px 10px 10px 10px; text-align:center; margin:2px 100px 100px 500px;" onclick="location.href='UpdateOrderController?grandtotal=<%=grandtotal%>&orderID=<%=orderid%>'">Proceed</button>
